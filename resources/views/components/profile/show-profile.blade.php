    ...
    <div class="card bg-dark text-white border-secondary shadow-sm rounded-4">
        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3">
                ...
                // Corretto con le colonne della tua tabella pivot ('episodes_watched')
                $currentEp = is_array($anime)
                ? ($anime['episodes_watched'] ?? $anime['watched_episodes'] ?? 0)
                : ($anime->pivot->episodes_watched ?? 0);

                $totalEp = is_array($anime)
